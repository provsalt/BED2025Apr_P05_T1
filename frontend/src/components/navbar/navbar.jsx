...
export const Navbar = () => {
  ...
  const navLinkClasses = "text-base font-semibold text-black";
    ...
    <nav className="flex items-center justify-between px-6 py-4 shadow-md bg-white">
      ...
      <div className="flex items-center gap-4">
        ...
        {isAuthenticated ? (
          ...
          <>
            <Button variant="ghost" asChild className="text-base font-semibold text-black rounded-md transition">
