...
const ChartTooltipContent = React.forwardRef(({ active, payload, label, indicator = "dot", hideLabel = false, hideIndicator = false, labelFormatter, labelClassName, labelKey, nameKey, className, ...props }, ref) => {
...
function getPayloadConfigFromPayload(config, payload, key) {
  ...
  if (payloadPayload && key in payloadPayload && typeof payloadPayload[key] === "string") {
    return config[payloadPayload[key]]
  }
